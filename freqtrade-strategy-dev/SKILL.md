...
- **[Indicators Guide](references/indicators-guide.md)** — Technical indicator formulas and interpretation
- **[Iteration Workflow](references/iteration-workflow.md)** — Step-by-step walkthrough of strategy optimization
